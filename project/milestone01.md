...
In this milestone you will be expected to choose a dataset appropriate for the DATA 301 team project.
...
- In the [DATA 301 GitHub organization]() on Github.com, one team member should create a public repository following this naming convention: `group_##_SOME_RELATED_NAME` (the ## is your group number from Canvas).
