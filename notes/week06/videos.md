...
<input type="checkbox" id="week06_video1" class="box"><label>6.1 Seaborn Tutorial by Derek Banas</input></label>
```
````
## Required Videos

```{dropdown} 6.1 Seaborn Tutorial by Derek Banas
...
[Companion Notebook](Class6B/Class6B)
