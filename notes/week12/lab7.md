...
In this lab you will prepare and publish the dashboard for your project. If not already done so, your first step before working on the dashboard is to fill in this [survey](https://ubc.ca1.qualtrics.com/jfe/form/SV_etwwurNao6VTE9w).
...
Commit your dashboard (tableau desktop file) to the GitHub repository. In the ReadMe file, provide the link to your tableau online dashboard.